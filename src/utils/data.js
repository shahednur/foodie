...
export const heropData =[
    ...
    {id:2, name: 'Strawberries', decp: 'Fresh Strawberries', 'price': '3.25', imageSrc: F1},
    {id:3, name: 'Chicken Kebab', decp: 'Mixed Chicken Kebab', 'price': '4.25', imageSrc: C3},
    {id:4, name: 'Fish', decp: 'Mixed Fish Kebab', 'price': '3.25', imageSrc: Fi1},
];
